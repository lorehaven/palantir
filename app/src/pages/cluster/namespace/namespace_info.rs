...
fn update_page(
    ...
    namespace_data: RwSignal<Vec<(&'static str, String)>>,
) {
    spawn_local(async move {
        ...
        items.push(("Created", format_timestamp(&namespace.metadata.creation_timestamp, None)));
...
fn view(
    ...
    view! {
        <div class="card-container dcc-1">
            <div class="card-list">
                {move || namespace_data.get().into_iter().map(|(name, value)| view! {

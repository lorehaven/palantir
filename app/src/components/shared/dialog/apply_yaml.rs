...
#[component]
pub fn ApplyYamlDialog(show_dialog: RwSignal<bool>) -> impl IntoView {
...
fn apply(yaml_content: RwSignal<String>, show_dialog: RwSignal<bool>, error: RwSignal<String>) {
    ...
    spawn_local(async move {
        if let Err(err) = apply_api::apply(json_str.clone()).await {
            match err {
